...
export const WithActivity: Story = {
  args: {
    logs: [
      { id: '1', userId: 'u1', deviceId: 'd1', rfidTagId: 't1', deviceName: 'Living Room Box', tagId: 'A1B2C3D4', jellyfinItemTitle: 'The Lion King', success: true, errorCode: null, createdAt: minute(2), device: { name: 'Living Room Box' } },
      { id: '2', userId: 'u1', deviceId: 'd1', rfidTagId: 't2', deviceName: 'Living Room Box', tagId: 'E5F6G7H8', jellyfinItemTitle: 'Moana', success: true, errorCode: null, createdAt: minute(15), device: { name: 'Living Room Box' } },
