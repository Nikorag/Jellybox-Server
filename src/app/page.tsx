  ...
  return (
    <div className="min-h-screen bg-jf-bg flex flex-col">
      ...
      <main className="flex-1 flex flex-col px-4 py-16 sm:py-20">
        ...
        {/* Feature grid */}
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-5xl w-full text-left mx-auto">
...
const features = [
  ...
  },
  {
    ...
    description:
      'An open HTTP contract lets you write extensions for any media source — no upstream changes needed. Self-host extensions as sidecars; they never have to be public.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
